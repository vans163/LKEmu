...
{
    public class PigmyGreen : Monster
    {
        public override string Name { get { return "Pigmy"; } }
        public override int HP { get { return 40; } }
        public override int Dam { get { return 4; } }
        public override int AC { get { return 6; } }
        public override int Hit { get { return 39; } }
        public override int XP { get { return 27; } }
        ...
        public PigmyGreen(Serial temp, int x, int y, string map)
            : this(temp)
        {
            m_MonsterID = 15;
        ...
        public PigmyGreen(Serial serial)
            : base(serial)
        {
        }
    }
