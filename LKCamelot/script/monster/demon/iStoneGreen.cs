...
{
    public class iStoneGreen : Monster
    {
        public override string Name { get { return "Stone"; } }
        public override int HP { get { return 210; } }
        ...
        public iStoneGreen(Serial temp, int x, int y, string map)
            : this(temp)
        {
            m_MonsterID = 6;
        ...
        public iStoneGreen(Serial serial)
            : base(serial)
        {
        }
    }
