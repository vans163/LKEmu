...
{
    public class iButcherRed : Monster
    {
        public override string Name { get { return "Butcher"; } }
        public override int HP { get { return 120; } }

        public override int AC { get { return 56; } }
        public override int Hit { get { return 81; } }
        public override int Dam { get { return 59; } }

        public override int XP { get { return 315; } }
        ...
        public iButcherRed(Serial temp, int x, int y, string map)
            : this(temp)
        {
            m_MonsterID = 8;
        ...
        public iButcherRed(Serial serial)
            : base(serial)
        {
        }
    }
