...
namespace LKCamelot.script.monster
{
    public class HardBoild060 : Monster
    {
        ...
        public HardBoild060(Serial temp, int x, int y, string map)
            : this(temp)
        {
            m_MonsterID = 28;
        ...
        public HardBoild060(Serial serial)
            : base(serial)
        {
        }
    }
