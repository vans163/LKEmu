...
{
    public class BoneDryBlue : Monster
    {
        public override string Name { get { return "Bone Dry"; } }
        public override int HP { get { return 130; } }

        public override int AC { get { return 39; } }
        public override int Hit { get { return 66; } }
        public override int Dam { get { return 39; } }

        public override int XP { get { return 153; } }
        ...
        public BoneDryBlue(Serial temp, int x, int y, string map)
            : this(temp)
        {
            m_MonsterID = 24;
        ...
        public BoneDryBlue(Serial serial)
            : base(serial)
        {
        }
    }
